        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BigPhotoId = table.Column<string>(type: "text", nullable: true),
                    BigPhotoUrl = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Responsed = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageResponses_Chats_ChatId",
                        column: x => x.ChatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageResponses_ChatId",
